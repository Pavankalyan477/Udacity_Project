...
function data(p) {
    ...
    if (p == 'datascience') {
        ...
        document.getElementById("a10").style.borderBottom = "2px solid blue";
        document.getElementById("a11").style.border = "none";
        document.getElementById("a12").style.border = "none";
        document.getElementById("a13").style.border = "none";
        ...
        document.getElementById('a12').style.fontWeight = "lighter";
        document.getElementById('a13').style.fontWeight = "lighter";
        document.getElementById("a11").style.borderBottom = "2px solid blue";
        document.getElementById("a10").style.border = "none";
        document.getElementById("a12").style.border = "none";
        document.getElementById("a13").style.border = "none";
        ...
        document.getElementById("a12").style.borderBottom = "2px solid blue";
        document.getElementById("a10").style.border = "none";
        document.getElementById("a11").style.border = "none";
        document.getElementById("a13").style.border = "none";
        ...
        document.getElementById("a13").style.borderBottom = "2px solid blue";
        document.getElementById("a10").style.border = "none";
        document.getElementById("a11").style.border = "none";
        document.getElementById("a12").style.border = "none";
